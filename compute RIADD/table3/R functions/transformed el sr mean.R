...
tel_mean=function(m=100,d=2,mu1=rep(0.5,times=d),threshold=500,trunction=1000){
...
tel1_mean=function(m=100,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=200,v=0){
  if(v<=d+1){
    x=matrix(0,nrow=m,ncol=d)
    for(i in 1:m){
      x[i,]=rgamma(n=d,shape=9,rate=2)
