...
el_laplace=function(m=100,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=200,trunction=1000){
...
el1_laplace=function(m=50,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=200,v=0){
  if(v<=2+1){
