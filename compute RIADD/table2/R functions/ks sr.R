...
library(ks)
ks_sr=function(m=100,d=2,threshold=500,mu0=rep(0,times=d),mu1=rep(0.5,times=d),covar=diag(1,d,d),trunction=1000){
  c=0
  r=0
...
ks1_sr=function(m=100,d=2,threshold=500,mu0=rep(0,times=d),mu1=rep(0.5,times=d),covar=diag(1,d,d),v=0){
  if(v<=1){
