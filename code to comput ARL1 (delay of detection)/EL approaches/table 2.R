...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    el1_laplace(threshold =1410 ,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    ael1_laplace(threshold =28 ,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tel1_laplace(threshold =69 ,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tael1_mean(threshold =29.98,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tael1_laplace(threshold =32,m=20)
  }
...
ael1_laplace=function(m=50,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=200){
  false=0
...
ael1_mean=function(m=100,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
...
el1_laplace=function(m=50,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=matrix(0,ncol=1,nrow=m)
  x2=matrix(0,ncol=1,nrow=m)
...
el1_mean=function(m=100,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=mvrnorm(n = m, mu=mu1, Sigma=diag(1,d,d))
  x5=colMeans(x)
...
tael1_laplace=function(m=50,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=matrix(0,ncol=1,nrow=m)
  x2=matrix(0,ncol=1,nrow=m)
...
tael1_mean=function(m=50,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=mvrnorm(n = m, mu=mu1, Sigma=diag(1,d,d))
  x5=colMeans(x)
...
tel1_laplace=function(m=100,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=matrix(0,ncol=1,nrow=m)
  x2=matrix(0,ncol=1,nrow=m)
...
tel1_mean=function(m=100,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
  x1=mvrnorm(n = m, mu=mu1, Sigma=diag(1,d,d))
  x5=colMeans(x)
