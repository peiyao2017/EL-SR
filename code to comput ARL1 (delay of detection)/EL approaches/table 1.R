...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    el1_laplace(threshold =1700,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    ael1_laplace(threshold =40.6,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tel1_laplace(threshold =128,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tael1_mean(threshold =32.5,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tael1_laplace(threshold =40.6,m=20)
  }
...
x=data.frame(arl1[1:2000],arl2[1:2000],arl3[1:2000],arl4[1:2000],arl5[1:2000],arl6[1:2000],arl7[1:2000],arl8[1:2000])
...
tael1_mean=function(m=50,mu0=0,mu1=0.5,threshold=20){
  false=0
  x=rnorm(n = m, mean=mu0,sd=1)
  x1=rnorm(n = m, mean=mu1, sd=1)
  x5=mean(x)
