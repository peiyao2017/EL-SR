...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    el1_laplace(threshold = 402000,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    ael1_laplace(threshold =42.8,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tel1_laplace(threshold =900,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tael1_mean(threshold =39.8,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tael1_laplace(threshold =46.6,m=20)
  }
...
ael1_laplace=function(m=100,d=4,mu1=rep(0.5,times=d),threshold=200){
  false=0
  ...
  for(i in 1:m){
    x7[i,]=c(exp(-y1%*%(x[i,]+mu1)),exp(-y2%*%(x[i,]+mu1)))
  }
  x8=colMeans(x7)
  repeat{
    c=d+1
...
ael1_mean=function(m=100,d=4,mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=9,rate=2)
...
el1_laplace=function(m=50,d=4,mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=9,rate=2)
...
el1_mean=function(m=100,d=4,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=9,rate=2)
...
tael1_laplace=function(m=100,d=4,mu1=rep(0.5,times=d),threshold=200){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=9,rate=2)
...
tael1_mean=function(m=50,d=4,mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=9,rate=2)
...
tel1_laplace=function(m=100,d=4,mu1=rep(0.5,times=d),threshold=2){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=9,rate=2)
...
tel1_mean=function(m=100,d=4,mu1=rep(0.5,times=d),threshold=200){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rgamma(n=d,shape=9,rate=2)
