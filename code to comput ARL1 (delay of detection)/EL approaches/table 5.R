...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    ael1_laplace(threshold =20,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tel1_laplace(threshold =20,m=20)
  }
...
repeat{
  a=foreach(i=1:1000, .combine="c")%dopar%{
    library(el.convex)
    library(MASS)
    tael1_laplace(threshold =20,m=20)
  }
...
ael1_laplace=function(m=100,d=4,threshold=200,min0=-1,max0=1,min1=-1.1,max1=1.1){
  false=0
...
el1_laplace=function(m=100,d=4,threshold=2.1,min0=-1,max0=1,min1=-1.1,max1=1.1){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=runif(n=d,min=min0,max=max0)
...
el1_var=function(m=100,d=4,threshold=200,min0=-1,max0=1,min1=-1.1,max1=1.1){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=runif(n=d,min=min0,max=max0)
...
tael1_laplace=function(m=100,d=4,threshold=200,min0=-1,max0=1,min1=-1.1,max1=1.1){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=runif(n=d,min=min0,max=max0)
...
tael1_var=function(m=50,d=4,threshold=200,min0=-1,max0=1,min1=-1.1,max1=1.1){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=runif(n=d,min=min0,max=max0)
...
tel1_laplace=function(m=100,d=4,threshold=200,min0=-1,max0=1,min1=-1.1,max1=1.1){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=runif(n=d,min=min0,max=max0)
...
tel1_var=function(m=100,d=4,threshold=200,min0=-1,max0=1,min1=-1.1,max1=1.1){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=runif(n=d,min=min0,max=max0)
