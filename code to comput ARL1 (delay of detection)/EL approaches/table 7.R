...
ael1_laplace=function(m=100,d=4,threshold=200,lambda0=4,lambda1=4.5){
  false=0
...
el1_laplace=function(m=100,d=2,threshold=2.1,lambda0=4,lambda1=4.5){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=rpois(n=d,lambda=lambda0)
...
ael1_mean=function(m=100,d=4,lambda0=4,lambda1=4.8,threshold=2){
  false=0
...
el1_mean=function(m=100,d=4,lambda0=4,lambda1=4.8,threshold=200){
  false=0
  x=matrix(0,nrow=m,ncol=d)
...
tael1_mean=function(m=100,d=4,lambda0=4,lambda1=4.5,threshold=2){
  false=0
  x=matrix(0,ncol = d,nrow=m)
  y=matrix(0,ncol = d,nrow=m)
  for(i in 1:m){
