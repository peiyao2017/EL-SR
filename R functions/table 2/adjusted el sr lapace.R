...
ael_laplace=function(m=50,d=2,mu0=rep(0,times=d),mu1=rep(0.5,times=d),threshold=200){
 ...
 ael1_laplace=function(m=50,d=4,mu0=rep(0,times=4),mu1=rep(0.5,times=4),threshold=200){
   false=0
   x=mvrnorm(n = m, mu=mu0, Sigma=diag(1,d,d))
   x1=matrix(0,ncol=1,nrow=m)
   x2=matrix(0,ncol=1,nrow=m)
