...
ael_laplace=function(m=100,d=2,threshold=100,min0=-1,max0=1,min1=-1.1,max1=1.1){
...
ael1_laplace=function(m=100,d=2,threshold=200,min0=-1,max0=1,min1=-1.1,max1=1.1){
  false=0
  x=matrix(0,nrow=m,ncol=d)
  for(i in 1:m){
    x[i,]=runif(n=d,min=min0,max=max0)
