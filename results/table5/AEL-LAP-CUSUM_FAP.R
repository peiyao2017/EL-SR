...
ael1_laplace=function(m=100,d=4,threshold=200,min0=-3,max0=3,min1=-3.5,max1=3.5){
  false=0
...
outname="table5_AEL-LAP-CUSUM.RData"
result=list(data.frame(size,thresholds,FAP))
